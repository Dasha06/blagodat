...
public partial class CreateOrderWindow : Window
{
    ...
    private void SelectedClient_Changed(object? sender, SelectionChangedEventArgs e)
    {
        throw new System.NotImplementedException();
    }
    ...
    private void SetupAutoComplete()
    {
        ...
        // Настраиваем отображение (можно кастомный шаблон)
    ...
    private void SelectedService_Changed(object? sender, SelectionChangedEventArgs e)
    {
